...
public class ELECTRE{
    ...
    public void rankAlternatives(){
        ...
        try {
            ...
            System.out.println(this.concordance.size());
    ...
    public HashMap<String, ArrayList<Integer>> getConcordance(double[][] weighteddMatrix){
        ...
        for (int r = 0; r < weighteddMatrix.length; r++) {
            for (int s = 0; s < weighteddMatrix.length; s++) {
                ...
                for (int j = 0; j < weighteddMatrix[0].length; j++) {
    ...
    public HashMap<String, ArrayList<Integer>> getDiscordance(double[][] weighteddMatrix){
        ...
        for (int r = 0; r < weighteddMatrix.length; r++) {
            for (int s = 0; s < weighteddMatrix.length; s++) {
                ...
                for (int j = 0; j < 11; j++) {
                    if(concMap.get(rs).contains(j) != true){
                        discordanceMap.get(rs).add(j);
                    }
                }
    ...
    public double[] computeScores(double[][] decisionMatrix) {
    	...
    	double[] scores = new double[numRows]; //new double[numAlternatives];
